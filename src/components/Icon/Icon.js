// Search
const IconSearch = ({ width, height, padding = 0, margin = 0 }) => {
    return (
        <svg
...
const IconXMarkCircle = ({ width, height, padding = 0, margin = 0 }) => {
    return (
        <svg
            style={{ width, height, margin, padding }}
            viewBox="0 0 48 48"
...
const IconSpinnerCircle = ({ width, height, padding = 0, margin = 0, className }) => {
    return (
        <svg
            className={className}
            style={{ width, height, margin, padding }}
...
const IconPlus = ({ width, height, padding = 0, margin = 0, className }) => {
    return (
        <svg
            className={className}
            style={{ width, height, margin, padding }}
...
const IconElipsis = ({ width, height, padding = 0, margin = 0, className }) => {
    return (
        <svg
            style={{ width, height, margin, padding }}
            viewBox="0 0 48 48"
...
const IconPaperPlane = ({ width, height, padding = 0, margin = 0, className }) => {
    return (
        <svg
            className={className}
            style={{ width, height, margin, padding }}
...
const IconMessageBox = ({ width, height, padding = 0, margin = 0, className }) => {
    return (
        <svg
            className={className}
            style={{ width, height, margin, padding }}
...
const IconUser = ({ width = '26px', height = '26px', margin = 0, padding = 0 }) => {
    return (
        <svg
            className="css-g0144v"
            style={{ width: width, height: height, padding, margin }}
            viewBox="0 0 48 48"
            fill="currentColor"
            xmlns="http://www.w3.org/2000/svg"
        >
...
const IconTiktokCircle = ({ width = '26px', height = '26px', margin = 0, padding = 0 }) => {
    return (
        <svg
            className="css-g0144v"
            style={{ width: width, height: height, margin, padding }}
            viewBox="0 0 20 20"
            fill="currentColor"
            xmlns="http://www.w3.org/2000/svg"
        >
...
const IconGear = ({ width = '26px', height = '26px', margin = 0, padding = 0 }) => {
    return (
        <svg
            className="css-g0144v"
            style={{ width: width, height: height, margin, padding }}
...
const IconLanguages = ({ width = '26px', height = '26px', margin = 0, padding = 0 }) => {
    return (
        <svg
            className="css-g0144v"
            style={{ width: width, height: height, padding, margin }}
...
const IconQuestion = ({ width = '26px', height = '26px', margin = 0, padding = 0 }) => {
    return (
        <svg
            className="css-g0144v"
            style={{ width: width, height: height, margin, padding }}
...
const IconKeyboardCircle = ({ width = '26px', height = '26px', margin = 0, padding = 0 }) => {
    return (
        <svg
            className="css-g0144v"
            style={{ width: width, height: height, padding, margin }}
...
const IconLogout = ({ width = '26px', height = '26px', margin = 0, padding = 0 }) => {
    return (
        <svg
            className="css-g0144v"
            style={{ width: width, height: height, margin, padding }}
